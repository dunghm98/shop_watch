<%@ Page Title="" Language="C#" MasterPageFile="~/backend/App.Master" AutoEventWireup="true" CodeBehind="NewBrand.aspx.cs" Inherits="UI.backend.WebForm10" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head_title" runat="server">Nhãn hiệu mới
</asp:Content>
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Nhãn hiệu mới</li>
					</ol>
				</div>
			</div>
		</div>

<%@ Page Title="" Language="C#" MasterPageFile="~/backend/App.Master" AutoEventWireup="true" CodeBehind="NewProduct.aspx.cs" Inherits="UI.backend.WebForm8" %>
			...
			<div class="row mt-5">
				<div class="col-md-12">
					<div class="form-group row">
						<asp:Label ID="Label1" class="col-md-5 col-form-label text-right" Style="cursor: pointer; user-select: none;" runat="server" Text="Bật/tắt" AssociatedControlID="txtProductName"></asp:Label>
						<div class="col-md-7">
							<!-- add class p-switch -->
							<label class="switch">
								<input type="checkbox" runat="server" id="chkboxEnable" checked="checked">
								<span class="slider"></span>
							</label>
						</div>
					</div>
					<div class="form-group row">
						<asp:Label class="col-md-5 col-form-label text-right" Style="cursor: pointer; user-select: none;" runat="server" Text="Tên sản phẩm <label class='text-red'>*</label>" AssociatedControlID="txtProductName"></asp:Label>
						<div class="col-md-7">
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<asp:TextBox ID="txtProductPrice" runat="server" CssClass="form-control" placeholder="Giá" Width="15%" Text="0"></asp:TextBox>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-md-7">
							<asp:TextBox ID="txtSales" runat="server" CssClass="form-control" placeholder="Nhập mức sale (%)" Width="16%" Text="0"></asp:TextBox>
						</div>
					</div>
					<div class="form-group row">
						<asp:Label ID="Label2" class="col-md-5 col-form-label text-right" Style="cursor: pointer; user-select: none;" runat="server" Text="Kho hàng" AssociatedControlID="txtForGender"></asp:Label>
						<div class="col-md-7">
							<div class="dropdown">
								<div class="select">
									<span>Còn hàng</span> <i class="fa fa-chevron-left"></i>
								</div>
								<asp:TextBox type="hidden" name="gender" ID="txtStock" runat="server" Text="1" />
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<div class="dropdown">
								<div class="select">
									<span>Chọn giới tính</span> <i class="fa fa-chevron-left"></i>
								</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<div class="dropdown">
								<div class="select">
									<span>Chọn nhãn hiệu</span> <i class="fa fa-chevron-left"></i>
								</div>
								<asp:TextBox type="hidden" name="gender" ID="txtBrand" runat="server" Text="-1" />
								<ul class="dropdown-menu">
					...
					<div class="card card-outline card-info collapsed-card">
						...
						<div class="card-body">
							<div class="uploadOuter">
								<asp:Label runat="server" AssociatedControlID="productImage" CssClass="btn btn-primary cursor-pointer" Text="Tải ảnh lên" />
								<strong>HOẶC</strong> <span class="dragBox">Kéo 1 ảnh vào đây
									<asp:FileUpload ID="productImage" runat="server" onchange="dragNdrop(event)" ondragover="drag()" ondrop="drop()" class="cursor-pointer" />
								</span>
							</div>
							<div id="preview">
							</div>
